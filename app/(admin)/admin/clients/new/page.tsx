      ...
      <form action={action} className="space-y-5">
        ...
        <div className="bg-psy-paper border border-psy-border rounded-xl p-5 space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              <label className="block text-xs font-medium text-psy-ink mb-1">Plan</label>
              <select
                name="plan"
                className="w-full px-3 py-2 rounded-lg border border-psy-border bg-psy-cream text-psy-ink text-sm focus:outline-none focus:ring-2 focus:ring-psy-blue/30"
              >
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          <button
            type="submit"
            disabled={pending}
            className="flex items-center justify-center gap-2 rounded-lg bg-psy-blue px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-psy-blue/90 disabled:opacity-50"
          >
          ...
          <Link
            href="/admin/clients"
            className="rounded-lg border border-psy-border px-5 py-2.5 text-center text-sm text-psy-muted transition-colors hover:bg-psy-paper hover:text-psy-ink"
          >
            Cancelar
          </Link>
        </div>
